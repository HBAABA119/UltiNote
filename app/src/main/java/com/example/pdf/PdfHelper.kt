...
object PdfHelper {
    ...
    suspend fun exportNoteToPdf(
        ...
        try {
            for ((index, pageEntity) in pages.withIndex()) {
                ...
                for (st in stickers) {
                    val glyph = com.example.data.model.StickerCatalog.glyphFor(st.stickerKey)
                    val sPaint = Paint().apply {
    ...
    private fun drawTemplateOnCanvas(canvas: Canvas, template: com.example.data.model.PaperTemplate, w: Float, h: Float) {
        ...
        when (template) {
            ...
            com.example.data.model.PaperTemplate.DOTTED -> {
                var y = 40f
                while (y < h - 20f) {
                    var x = 40f
                    while (x < w - 20f) {
            ...
            com.example.data.model.PaperTemplate.BLANK -> { /* clean paper */ }
            com.example.data.model.PaperTemplate.PLANNER_WEEKLY -> {
                val colW = w / 7f
            ...
            com.example.data.model.PaperTemplate.DARK_PAPER -> {
            ...
            com.example.data.model.PaperTemplate.ENGINEERING_GRID -> {
                var x = 0f
            ...
            com.example.data.model.PaperTemplate.MUSIC_STAVE -> {
                var y = 120f
                while (y < h - 80f) {
            ...
            com.example.data.model.PaperTemplate.PASTEL_WASH -> {
                var y = 60f
